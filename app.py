...
def is_allowed_color(color_data):
    ...
    # สีฟ้า (Cyan): B และ G ต้องสูงกว่า R อย่างชัดเจน
    # ค่อนข้างหลวม: B หรือ G อย่างน้อย > 100 และสูงกว่า R
    is_blue = (b > r and g > r and (b >= 100 or g >= 100))
    
    # สีเหลือง (Yellow): R และ G ต้องสูงกว่า B อย่างชัดเจน
    # ค่อนข้างหลวม: R หรือ G อย่างน้อย > 100 และสูงกว่า B
    is_yellow = (r > b and g > b and (r >= 100 or g >= 100))
