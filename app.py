...
# ================== COLOR LOGIC (ปรับปรุงให้แม่นยำขึ้น) ==================
...
def is_allowed_color(color_hex):
    ...
    # 1. เช็ค Hex ตรงตัวที่พบบ่อย
    if clean_hex in ["ffff00", "00ffff", "00ffff", "cyan", "yellow"]:
        return True
    ...
    # 🟡 สีเหลือง: Red และ Green ต้องสูง และต้องมากกว่า Blue อย่างชัดเจน
    is_yellow = (r > 150 and g > 150) and (r > b + 60 and g > b + 60)
    
    # 🔵 สีฟ้า (Cyan): Green และ Blue ต้องสูง และต้องมากกว่า Red อย่างชัดเจน
    # จากรูป 'หนองกี่' คือ Cyan สว่าง (Red จะต่ำมาก)
    is_blue = (g > 150 and b > 150) and (g > r + 60 and b > r + 60)
...
def get_district_info(district_name):
    ...
    for row_idx in sorted_keys:
        ...
        if target == h_val:
            ...
            # ถ้าสีผ่านเงื่อนไข ให้รีบ return ทันที
            ...
            # ถ้าสีไม่ผ่าน จะวนหาแถวถัดไปต่อ (กรณีคีย์ชื่อเดียวกันไว้หลายที่)
